...
class OverviewScreen(BoxLayout):
    def __init__(self, orientation='horizontal', spacing=20, padding=20, **kwargs):
        ...
        with self.canvas.before:
            ...
            self.bg_rect = Rectangle(source="assets\images\gameplay_bg", pos=self.pos, size=Window.size)
        ...
        # Content
        column_1.add_widget(Button(text="Spacer"))

        list = [0, 1]
        for x in list:
            column_2.add_widget(Button(text=str(x)))
